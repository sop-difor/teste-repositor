...
| F6 | **concluída** — 4/4 `APROVADO` ([`fase-6-revisao.md`](fase-6-revisao.md)). SQL gerado exibido ao usuário; prompt do LLM ganhou as views largas da F4; badge "resposta gerada — confira"; degradação anexa perguntas de exemplo. **Ainda não publicada em produção** |
| F7–F8 | não iniciadas |
